import { DocNode, DocNodeClass, DocNodeInterface, DocNodeNamespace } from "@deno/doc/types";
import { HasNamespace } from "../types.ts";

export function mergeSymbolsWithCollidingNames(symbolsByName: Map<string, (DocNode & HasNamespace)[]>) {
